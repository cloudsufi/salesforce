...
public class SalesforceConstants {
  ...
  public static final String CONFIG_PROXY_USERNAME = "mapred.salesforce.proxyUsername";
  public static final String CONFIG_PROXY_PASSWORD = "mapred.salesforce.proxyPassword";
}
