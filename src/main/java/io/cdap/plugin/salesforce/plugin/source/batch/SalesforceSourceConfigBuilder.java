...
public class SalesforceSourceConfigBuilder {
  ...
  public SalesforceSourceConfigBuilder setProxyUsername(String proxyUsername) {
    this.proxyUsername = proxyUsername;
    return this;
  }

  public SalesforceSourceConfigBuilder setProxyPassword(String proxyPassword) {
  ...
  public SalesforceSourceConfig build() {
    return new SalesforceSourceConfig(referenceName, consumerKey, consumerSecret, username, password, loginUrl,
                                      ...
                                      chunkSize, parent, proxyUrl, proxyUsername, proxyPassword);
  }
}
